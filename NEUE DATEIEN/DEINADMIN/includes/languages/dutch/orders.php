 ...
 * @version $Id: orders.php 2024-04-04 11:49:16Z webchills $
 */
...
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_MALE', 'Geachte heer ');
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_FEMALE', 'Geachte mevrouw ');
define('EMAIL_TEXT_ORDER_CUSTOMER_NEUTRAL', 'Goedendag ');
define('EMAIL_TEXT_UPDATEINFO', 'Wij informeren u over de status van uw bestelling met ');
