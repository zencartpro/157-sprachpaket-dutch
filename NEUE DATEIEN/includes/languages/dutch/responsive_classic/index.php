...
* @version $Id: index.php 2024-04-04 09:00:16Z webchills $
 */

  define('TEXT_GREETING_GUEST', 'Welkom <span class="greetUser">bezoeker!</span> Wilt u zich <a href="%s">aanmelden</a>?');

  define('TEXT_GREETING_GUEST_SHOWCASE', 'Welkom, kijk rustig rond in onze showroom.');
...
define('TEXT_INFORMATION', 'De welkomstpagina van je bedrijf kun je hier kwijt.');
  ...
  define('TEXT_NOW', '\' nu');
define('HEADING_TITLE_PRODUCTS' , 'Beschikbare artikelen');


  define('HEADING_TITLE', 'Welkom in onze online winkel!');

  define('HEADING_TITLE_NESTED', 'Welkom in onze online winkel!');