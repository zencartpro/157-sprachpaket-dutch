...
define('MODULES_PAYMENT_PAYPALWPP_MESSAGE_STACK_CHECKOUT_SHIPPING', 'U betaalt met PayPal en gebruikt een verzendadres dat bij PayPal bekend is.<br>We willen er zeker van zijn dat dit verzendadres correct is, daarom hebben we u teruggeleid naar deze pagina.<br>Controleer het verzendadres en verander het indien nodig.<br>Klopt het adres? Prima! <br>Klik rechtsonder op doorgaan en bevestig dan nogmaals in de laatste stap door op de knop Kopen te klikken.<br>PayPal betaling en bestelling worden pas verwerkt als u de bestelling op deze manier bevestigt.');