...
define('MODULE_PAYMENT_SOFORT_SU_TEXT_ERROR_MESSAGE', 'De gekozen betaalwijze is helaas niet mogelijk of is op verzoek van de klant geannuleerd. Selecteer een andere betaalmethode.');